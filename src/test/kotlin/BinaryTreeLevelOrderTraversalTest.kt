...
class BinaryTreeLevelOrderTraversalTest{
    val binaryTreeLevelOrderTraversal = BinaryTreeLevelOrderTraversal()
    ...
    fun shouldProvideTreeLevelsEx1() {
        ...
        val result = binaryTreeLevelOrderTraversal.levelOrder(treeNodeRoot)
    ...
    @Test
    fun shouldProvideTreeLevelsEx4() {
        val treeNodeRoot = null
    ...
    fun shouldProvideTreeLevelsEx1Recursively() {
        ...
        val result = binaryTreeLevelOrderTraversal.levelOrderRecursivelyHelper(treeNodeRoot)
        assertContentEquals(expectedOutput[0], result[0])
        assertContentEquals(expectedOutput[1], result[1])
        assertContentEquals(expectedOutput[2], result[2])
    }
    ...
    @Test
    fun shouldProvideTreeLevelsEx4Recursively() {
        val treeNodeRoot = null
